...
<create_file path="c:/Users/PJH/소상공인플렛폼/sessions/2026-05-29T14-35/mvp_final_roadmap_kpi_risk_connect.md"><find>Phase 1 핵심 기능 상세: P0 & P1</find><replace>Phase 1 핵심 기능 상세: P0(실시간 데이터 동기화) 와 P1(KPI Gauge 컴포넌트)</replace>