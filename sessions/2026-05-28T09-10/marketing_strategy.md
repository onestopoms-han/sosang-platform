<find>마케팅 전략 수립 (데이터 기반)</find><replace>### 1. 상황 분석 및 데이터 확보 필요
...
**다음 단계:** 코다리 에이전트에게 Mock Data 환경에서 KPI 상태 로그 및 Pain Point 데이터를 요청합니다. 데이터가 확보된 후 재분석 작업을 시작하겠습니다.</replace>